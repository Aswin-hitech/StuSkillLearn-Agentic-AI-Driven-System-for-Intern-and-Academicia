      ...
      <main>
        <section className="border-b border-slate-200 bg-[#f7f9fc]">
          <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 lg:grid-cols-[1.1fr_.9fr] lg:items-center lg:py-28">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-sky-50 px-3 py-1.5 text-xs font-semibold text-sky-800"><Network className="h-3.5 w-3.5" /> 7-agent academia–industry collaboration</div>
        ...
        <section className="border-y border-slate-200 bg-slate-950 text-white">
          <div className="mx-auto grid max-w-7xl gap-8 px-5 py-16 md:grid-cols-3">
            ...
            <div><BriefcaseBusiness className="h-6 w-6 text-sky-400" /><h3 className="mt-4 font-semibold">Internship to placement continuity</h3><p className="mt-2 text-sm leading-6 text-slate-400">The same portable evidence portfolio and verified outcomes continue into placement matching instead of resetting the student journey.</p></div>
          </div>
        </section>
      </main>
    </div>
